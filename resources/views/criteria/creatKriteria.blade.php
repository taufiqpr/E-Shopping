              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="kode" placeholder="Masukan Kode Alternatif">
                    @error('kode')
                      <small>{{ $message}}</small>
                    @enderror
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="bobot" class="form-control" id="exampleInputEmail1" placeholder="Enter Bobot">
                    @error('bobot')
                      <small>{{ $message}}</small>
                    @enderror
                  </div>
